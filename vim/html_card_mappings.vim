...
" Html Card Title Container (include card and card header searches)
nnoremap <silent> ,hctc :call IndentTemplate('views/pages/card_title_container.html.erb')<return>/DeleteThis\\|ChangeTitle\\|ChangeSubTitle\\|ChangeActionButtons<return>
" Html Card Table
