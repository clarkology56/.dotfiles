" Html Modal FOrm
nnoremap <silent> ,hmfo :call IndentTemplate('views/modals/form_modal.html.erb')<return>/ChangeModel\\|ChangeSubControllerNameOrRemoveThis\\|ChangeActionOrDescription\\|ChangeHeader\\|ChangePath\\|ChangeHtmlMethod\\|ChangeSubmitToAddForNewOrSaveForUpdate\\|DeleteThis<return>
" Html Modal DEstroy
...
nnoremap <silent> ,hmis a<%# DeleteThis - use ,heil to see list of available icons %><return><i class="link no-underline fa-solid fa-pen-to-square" data-target-modal="ChangeModalId"></i><esc>/DeleteThis\\|ChangeModel\\|ChangeSubControllerNameOrRemoveThis\\|ChangeActionOrDescription<return>
...
nnoremap <silent> ,hmid a<i class="link no-underline link-danger fa-solid fa-trash-can" data-target-modal="ChangeModalId"></i><esc>/ChangeSubControllerNameOrRemoveThis\\|ChangeModel<return>
" Html Modal Button trigger Static
nnoremap <silent> ,hmbs a<button type="button" class="btn" data-target-modal="ChangeModalId">ChangeAction</button><esc>/ChangeModel\\|ChangeSubControllerNameOrRemoveThis\\|ChangeActionOrDescription\\|ChangeAction<return>
...
nnoremap <silent> ,hmls a<a class="link" data-target-modal="ChangeModalId">ChangeAction</a><esc>/ChangeModel\\|ChangeSubControllerNameOrRemoveThis\\|ChangeActionOrDescription\\|ChangeAction<return>
...
nnoremap <silent> ,hmld a<a class="link link-danger" data-target-modal="ChangeModalId">Delete ChangeModelDisplay</a><esc>/ChangeModelDisplay\\|ChangeSubControllerNameOrRemoveThis\\|ChangeModel<return>
