" Html Input Group Base
nnoremap <silent> ,higb :call IndentTemplate('views/forms/input_group.html.erb')<return>/DeleteThis\\|ChangeInputType\\|ChangeMethod<return>
" Html Input Group Base custom
nnoremap <silent> ,higB :call IndentTemplate('views/forms/input_group_custom.html.erb')<return>/DeleteThis\\|ChangeLabel<return>
" Html Input Group Radio
nnoremap <silent> ,higr :call IndentTemplate('views/forms/input_group_radio.html.erb')<return>/DeleteThis\\|ChangeLabel\\|ChangeMethod\\|ChangeValue\\|ChangeOrRemove<return>
" Html Input group Checkbox
nnoremap <silent> ,higc :call IndentTemplate('views/forms/input_group_checkbox.html.erb')<return>/DeleteThis\\|ChangeLabel\\|ChangeMethod\\|ChangeOrRemove<return>
...
nnoremap <silent> ,hisd :call IndentTemplate('views/forms/input_group_select_default.html.erb')<return>/ChangeMethod\\|DeleteThis\\|ChangeOptionsList\\|ChangeOrRemove<return>
