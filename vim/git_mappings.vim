...
" Git Status
nnoremap <silent> <space>gS :wa<return>:call ToggleTerminalInWindow('base', 1)<return>q<C-\><C-n>aq<C-c>!!!<return><C-c>git status<return><C-\><C-n>
nnoremap <silent> <space>gs :wa<return>:! git status<return>
" Git Diff
nnoremap <silent> <space>gd :wa<return>:call ToggleTerminalInWindow('base', 1)<return>q<C-\><C-n>aq<C-c>!!!<return><C-c>git diff<return>
" Git Test - single test at cursror position
nnoremap <silent> <space>gt :let current_window = winnr()<return>:call FileTestCurrentFile(1, 0)<return>:call ToggleTerminalInWindow('test', 1)<return>q<C-\><C-n>aq<C-c>!!!<return><C-c><C-\><C-n>pa<return><C-\><C-n><esc>:execute current_window . " wincmd w"<return>
" Git Test - entire file
nnoremap <silent> <space>gT :let current_window = winnr()<return>:call FileTestCurrentFile(1, 1)<return>:call ToggleTerminalInWindow('test', 1)<return>q<C-\><C-n>aq<C-c>!!!<return><C-c><C-\><C-n>pa<return><C-\><C-n><esc>:execute current_window . " wincmd w"<return>
" Git Test - all files
nnoremap <silent> <space>GT :let current_window = winnr()<return>:wa<return>:call ToggleTerminalInWindow('test', 1)<return>q<C-\><C-n>aq<C-c>!!!<return><C-c>mise run ci<return><C-\><C-n><esc>:execute current_window . " wincmd w"<return>


" Git push Up
nnoremap <silent> <space>gu :wa<return>:call ToggleTerminalInWindow('base', 1)<return>q<C-\><C-n>aq<C-c>!!!<return><C-c>git push -u<return><C-\><C-n>
