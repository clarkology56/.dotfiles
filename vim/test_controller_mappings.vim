...
nnoremap <silent> ,tcsh :call IndentTemplate('test/controllers/actions/show_html.rb')<return>/DeleteThis\\|ChangePath\\|ChangeFactory\\|ChangeResource<return>
...
nnoremap <silent> ,tcdb :call IndentTemplate('test/controllers/actions/destroy_broadcast.rb')<return>/DeleteThis\\|ChangePath\\|ChangeFactory\\|ChangeResource\\|ChangeResourceClass<return>
