...
nnoremap <silent> ,ambt abelongs_to :ChangeParentName<esc>/ChangeParentName<return>
...
nnoremap <silent> ,amho ahas_one :ChangeAssociation, dependent: :destroy<esc>/ChangeAssociation<return>
" App Models Has One association - full (when in different namespace or association name doesn't match model name)
nnoremap <silent> ,amhO ahas_one :ChangeAssociation, class_name: 'ChangeAssociationClass', foreign_key: :ChangeAssociation_id, inverse_of: :ChangeAssociationInOtherModel, dependent: :destroy<esc>/ChangeAssociationInOtherModel\\|ChangeAssociationClass\\|ChangeAssociation<return>
" App Models has One through association
nnoremap <silent> ,amHo ahas_one :ChangeAssociation, through: :ChangeConnectingAssociationName<esc>/ChangeAssociation\\|ChangeConnectingAssociationName<return>
...
nnoremap <silent> ,amhm ahas_many :ChangeChildrenName, dependent: :destroy<esc>/ChangeChildrenName<return>
" App Models Has Many association - full (when in different namespace or association name doesn't match model name)
nnoremap <silent> ,amhM ahas_many :ChangeChildrenName, class_name: 'ChangeChildClass', foreign_key: :ChangeParentName_id, inverse_of: :ChangeAssociationInOtherModel, dependent: :destroy<esc>/ChangeChildrenName\\|ChangeChildClass\\|ChangeParentName\\|ChangeAssociationInOtherModel<return>
" App Models has Many through association
nnoremap <silent> ,amHm ahas_many :ChangeChildrenName, through: :ChangeConnectingAssociationName<esc>/ChangeChildrenName\\|ChangeChildrenName\\|ChangeConnectingAssociationName\\|ChangeTopParentModel<return>
